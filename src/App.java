...
public class App {
    public static void main(String[] args) {
        ...
        Users.add(Alice);  // creation des usagers bob et alice 
        Users.add(Bob);
        String Input;
        String Adresse;
        String MotDePasse;
                            ...
                            if (MotDePasse.equals(resident.MotDePasse)) {
                                ...
                                while (true) {
                                    ...
                                    if ("1".equals(Input)) {
                                        ...
                                        Input = scanner.nextLine().trim();
                                        resident.ConsulterTravaux(Input);  // appel a la fontion
                                        continue;
                                        ...
                                        System.out.println(" Consulter liste des travaux par titre [1]"
                                                            ...
                                                            +"\n Retour au menu [4]");
                                        Input = scanner.nextLine().trim();
                                        resident.RechercheTravaux(Input); // appel a la fontion
                                        ...
                                        System.out.println(" S'abonner aux notifications pour des projets affectant une rue [1]"
                                                            ...
                                                            +"\n Retour au menu [3]");
                                        Input = scanner.nextLine().trim(); 
                                        resident.RecevoirNotifications(Input);    // appel a la fontion                               
                            ...
                            if (MotDePasse.equals(Intervenant.MotDePasse)) {
                                ...
                                if ("1".equals(Input)) {
                                    System.out.println(" Consulter la liste des requêtes de travail par type [1]"
                                                        ...
                                                        +"\n Retour au menu [4]");
                                    Input = scanner.nextLine().trim();
                                    Intervenant.Requetes(Input); // appel a la fontion
                                }else if ("2".equals(Input)) {
